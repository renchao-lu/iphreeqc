 ...
 */
	for (;;)
	{
		...
		{
            row_ptr = string_to_spread_row(const_cast<char*>(line.c_str()));
			ptr = line;
...
/* ---------------------------------------------------------------------- */
int Phreeqc::
copy_token_tab(std::string token_ptr, std::string ptr, int *length)
/* ---------------------------------------------------------------------- */
{
/*
